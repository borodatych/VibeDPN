...
│   ├── configSpec.md     # формат config.yaml — можно скормить модели целиком[languageFileSpec.md](manuals/languageFileSpec.md) — формат языкового файла панели: скопировать модели и получить перевод
