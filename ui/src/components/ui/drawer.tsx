...
function DrawerOverlay({ className, blurred = false, ...props }: DrawerOverlayProps) {
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        ...
        blurred && 'supports-backdrop-filter:backdrop-blur-xs',
        className,
      )}
      {...props}
    />
    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          rounded &&
            'data-[vaul-drawer-direction=bottom]:rounded-t-xl data-[vaul-drawer-direction=left]:rounded-r-xl data-[vaul-drawer-direction=right]:rounded-l-xl data-[vaul-drawer-direction=top]:rounded-b-xl',
          wider && 'data-[vaul-drawer-direction=left]:sm:max-w-md data-[vaul-drawer-direction=right]:sm:max-w-md',
          className,
        )}
        {...props}
      >
...
function DrawerTitle({ className, ...props }: React.ComponentProps<typeof DrawerPrimitive.Title>) {
  return (
    <DrawerPrimitive.Title
      ...
      className={cn('font-medium text-accent-foreground', className)}
      {...props}
    />
  )
}
